package br.com.microservice.project.fornecedor.lang;

public final class Constants {

	public static final String EMPTY = "";
	public static final String BLANK = " ";
	public static final String PACKAGE = "br.com.microservice.project.fornecedor";
	...
	public static final String FORNECEDOR = Constants.ROOT_URL + Constants.V1;
	public static final String PRODUTO = Constants.ROOT_URL + Constants.V1 + "/produto";
	public static final String PEDIDO = Constants.ROOT_URL + Constants.V1 + "/pedido";
