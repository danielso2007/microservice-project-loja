...
CREATE TABLE `pedido` (`id` bigint(20) NOT NULL AUTO_INCREMENT, `status` varchar(255) DEFAULT NULL, `tempo_de_preparo` int(11) DEFAULT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB DEFAULT CHARSET=latin1;
