...
INSERT INTO `fornecedor-dev`.pedido(status, tempo_de_preparo)VALUES('RECEBIDO', 80);
INSERT INTO `fornecedor-dev`.pedido(status, tempo_de_preparo)VALUES('PRONTO', 160);
INSERT INTO `fornecedor-dev`.pedido(status, tempo_de_preparo)VALUES('PRONTO', 80);
INSERT INTO `fornecedor-dev`.pedido(status, tempo_de_preparo)VALUES('ENVIADO', 80);
INSERT INTO `fornecedor-dev`.pedido(status, tempo_de_preparo)VALUES('RECEBIDO', 80);
INSERT INTO `fornecedor-dev`.pedido(status, tempo_de_preparo)VALUES('RECEBIDO', 160);
INSERT INTO `fornecedor-dev`.pedido(status, tempo_de_preparo)VALUES('ENVIADO', 40);
INSERT INTO `fornecedor-dev`.pedido(status, tempo_de_preparo)VALUES('PRONTO', 60);

INSERT INTO `fornecedor-dev`.pedido_item(quantidade, produto_id, pedido_id)VALUES(5, 1, 1);
INSERT INTO `fornecedor-dev`.pedido_item(quantidade, produto_id, pedido_id)VALUES(2, 2, 2);
INSERT INTO `fornecedor-dev`.pedido_item(quantidade, produto_id, pedido_id)VALUES(1, 3, 3);
INSERT INTO `fornecedor-dev`.pedido_item(quantidade, produto_id, pedido_id)VALUES(1, 4, 4);
INSERT INTO `fornecedor-dev`.pedido_item(quantidade, produto_id, pedido_id)VALUES(2, 5, 5);
INSERT INTO `fornecedor-dev`.pedido_item(quantidade, produto_id, pedido_id)VALUES(3, 6, 1);
INSERT INTO `fornecedor-dev`.pedido_item(quantidade, produto_id, pedido_id)VALUES(10, 7, 2);
INSERT INTO `fornecedor-dev`.pedido_item(quantidade, produto_id, pedido_id)VALUES(8, 8, 3);
INSERT INTO `fornecedor-dev`.pedido_item(quantidade, produto_id, pedido_id)VALUES(7, 9, 4);
INSERT INTO `fornecedor-dev`.pedido_item(quantidade, produto_id, pedido_id)VALUES(7, 8, 5);